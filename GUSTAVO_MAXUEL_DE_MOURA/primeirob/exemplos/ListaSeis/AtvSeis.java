...
import primeirob.exemplos.ListaSeis.Cliente;
import primeirob.exemplos.ListaSeis.Loja;
import primeirob.exemplos.ListaSeis.Vendedor;
import primeirob.exemplos.ListaSeis.Pedido;
import primeirob.exemplos.ListaSeis.Pessoa;
public class AtvSeis {
    public static void main(String[] args) {
        ...
        int quantidadePlanta = 0, posicao = 0;
        ...
        while (numero != 3) {
            ...
            switch (numero) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    lojaImport.apresentarLogradouro();
                    break;
                case 7:
                    vend.apresentarSe();
                    break;
