...
public class Ninja {
    ...
    public void apresentarse() {
        System.out.println("Ninja: ".concat(nome).concat("\n Cla: ".concat(cla)));
    }

    public void realizarJutso() {
        System.out.println(nome.concat(" realizando jutso ").concat(nomeJutso).concat(" \n"));
    }
    ...
    public void realizarInvocacao() {
        System.out.println("Realizar a invocação de um animal");
    }
