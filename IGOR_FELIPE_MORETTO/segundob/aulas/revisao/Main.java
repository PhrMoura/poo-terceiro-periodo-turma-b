...
//         quarto.setValorDiaria(input.nextDouble());
...
//                 System.out.print("Valor diária: R$" + quartos[i].getValorDiaria());
//                 System.out.println();
//             }
//         }
//     }
...
//         Date dataEntrada = DateUtil.yyyyMMddToDate(input.nextLine());

//         System.out.println("Informe data saida reserva!(dd/MM/yyyy)");
//         Date dataSaida = DateUtil.yyyyMMddToDate(input.nextLine());
...
//         Double valorDiariaQuarto = quartoReserva.getValorDiaria();
...
//         reserva.setValorTotalDiaria(valorTotalDiaria);
...
//             reservaCheck.setDataCheckIn(isCheckIn ? new Date() : null);
//             reservaCheck.setDataCheckOut(escolha.equals(2) ? new Date() : null);
